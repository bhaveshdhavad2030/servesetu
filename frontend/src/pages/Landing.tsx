...
const services = [
  { id: 1, name: 'Plumbing', icon: <Droplet className="h-6 w-6" />, color: 'bg-blue-100 text-[#0071BD]', price: 499 },
  { id: 2, name: 'Electrical', icon: <Zap className="h-6 w-6" />, color: 'bg-blue-100 text-[#0071BD]', price: 599 },
  { id: 3, name: 'Appliances', icon: <Search className="h-6 w-6" />, color: 'bg-blue-100 text-[#0071BD]', price: 699 },
  { id: 4, name: 'AC Service', icon: <Wind className="h-6 w-6" />, color: 'bg-blue-100 text-[#0071BD]', price: 799 },
  { id: 5, name: 'Painting', icon: <Palette className="h-6 w-6" />, color: 'bg-blue-100 text-[#0071BD]', price: 999 },
] as const

const benefits = [
  {
    icon: <Shield className="h-8 w-8 text-[#0071BD]" />,
    title: '100% Safe & Secure',
    desc: 'Every technician is background checked and verified for your peace of mind.',
  },
  {
    icon: <Clock className="h-8 w-8 text-[#0071BD]" />,
    title: 'On-Time Service',
    desc: 'We value your time. Our pros arrive when scheduled, with clear updates if anything changes.',
  },
  {
    icon: <Award className="h-8 w-8 text-[#0071BD]" />,
  ...
  return (
    <PublicSiteLayout>
      <section className="relative overflow-hidden bg-white pt-32 pb-20 md:pt-44 md:pb-28">
        ...
        <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center gap-16 px-4 sm:px-6 lg:flex-row lg:px-8">
          <div className="flex-1 text-center lg:text-left">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-sm font-semibold text-[#0071BD]">
              <span className="relative flex h-2 w-2">
                <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#0071BD] opacity-75" />
                <span className="relative inline-flex h-2 w-2 rounded-full bg-[#0071BD]" />
              </span>
              Trusted home services across India
            </div>

            <h1 className="mb-8 text-4xl font-extrabold leading-[1.05] tracking-tight text-[#005A99] md:text-6xl">
              Quality repairs,
              <br />
              <span className="text-[#0071BD]">exactly when</span>
              <br />
              you need them.
            </h1>
            ...
            <div className="flex flex-col justify-center gap-4 sm:flex-row lg:justify-start">
              <button
                ...
                className="flex items-center justify-center gap-3 rounded-2xl bg-[#005A99] px-8 py-4 text-lg font-bold text-white shadow-xl shadow-[#005A99]/20 transition-all hover:-translate-y-0.5 hover:bg-[#0071BD] active:scale-95"
              >
                Book a Service
              ...
              <div className="flex items-center gap-4 rounded-2xl border border-gray-100 bg-white px-6 py-4 shadow-sm">
                ...
                <div className="text-left">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="font-bold text-[#005A99]">4.9/5</span>
                  </div>
          ...
          <div className="flex w-full flex-1 items-center justify-center">
            <div className="relative w-full max-w-xl overflow-hidden rounded-[2.5rem] border-4 border-white bg-gray-50 p-4 shadow-2xl">
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-[#005A99]/10 via-transparent to-transparent" />
              <div className="absolute right-6 bottom-6 left-6 rounded-2xl border border-gray-100 bg-white/95 p-4 shadow-xl backdrop-blur-md">
                <div className="flex items-center gap-4">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#005A99] shadow-lg">
                    <Wrench className="h-5 w-5 text-white" />
                  </div>
                  <div className="text-left">
                    <p className="font-bold text-[#005A99]">Verified Expert</p>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mb-16 flex flex-col justify-between gap-6 md:flex-row md:items-end">
            <div className="w-full text-center md:w-auto md:text-left">
              <h2 className="mb-3 text-sm font-bold uppercase tracking-wider text-[#0071BD]">Our Expertise</h2>
              <h3 className="text-4xl font-extrabold text-[#005A99] md:text-5xl">Explore services</h3>
            </div>
          ...
          <div className="grid grid-cols-2 gap-6 lg:grid-cols-5">
            {services.map((service) => (
              ...
              >
                ...
                <h3 className="mb-2 truncate text-xl font-bold text-[#005A99]">{service.name}</h3>
                <div className="flex items-center gap-1.5 text-sm font-medium text-gray-500">
                  Starts at <span className="font-bold text-[#005A99]">₹{service.price}</span>
                </div>
              </button>
            ))}
          </div>
          ...
          <div className="grid gap-12 lg:grid-cols-3">
            {benefits.map((benefit) => (
              ...
              >
                ...
                <h3 className="mb-4 text-2xl font-extrabold text-[#005A99]">{benefit.title}</h3>
      ...
      <section className="relative overflow-hidden bg-white py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-[3rem] bg-[#005A99] p-12 text-center md:p-24">
            ...
            <div className="relative z-10 mx-auto max-w-2xl text-white">
              ...
              <button
                type="button"
                onClick={() => navigate('/services')}
                className="mx-auto flex items-center justify-center gap-3 rounded-2xl bg-white px-10 py-5 text-xl font-bold text-[#005A99] shadow-2xl transition-all hover:scale-105 hover:bg-blue-50 active:scale-95"
              >
                Browse Marketplace
