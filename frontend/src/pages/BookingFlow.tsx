      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid gap-8 lg:grid-cols-[1.5fr_0.9fr]">
          <section className="rounded-[2rem] bg-white border border-slate-200 shadow-sm p-8">
            <div className="mb-10">
              <p className="text-sm uppercase tracking-[0.3em] text-[#0071BD] mb-3">Booking details</p>
            ...
            <div className="grid gap-6 sm:grid-cols-2 mb-8">
              <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-5">
                <div className="mb-4 inline-flex items-center gap-2 text-[#005A99] font-semibold">
                  <CalendarDays className="w-5 h-5" /> Preferred Date
                </div>
                <input className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#0071BD]" type="date" />
              </div>
              <div className="rounded-[1.75rem] border border-slate-200 bg-slate-50 p-5">
                <div className="mb-4 inline-flex items-center gap-2 text-[#005A99] font-semibold">
                  <Clock className="w-5 h-5" /> Preferred Time
                </div>
                <select className="w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#0071BD]">
            ...
            <div className="rounded-[2rem] border border-slate-200 bg-slate-50 p-6 mb-8">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <input type="text" placeholder="Enter your address" className="mt-2 w-full rounded-2xl border border-slate-300 bg-white px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#0071BD]" />
                </div>
              </div>
              <div className="rounded-2xl bg-white p-5 border border-slate-200">
                ...
                <textarea rows={4} placeholder="Describe the problem here" className="w-full rounded-2xl border border-slate-300 px-4 py-3 focus:outline-none focus:ring-2 focus:ring-[#0071BD]" />
              </div>
            </div>

            <button className="w-full rounded-[2rem] bg-[#005A99] px-6 py-4 text-lg font-semibold text-white shadow-xl shadow-[#005A99]/20 hover:bg-[#0071BD] transition">
              Confirm Booking Now
            </button>
          </section>
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-[2rem] bg-white border border-slate-200 p-8 shadow-sm">
              ...
              <ul className="space-y-3 text-slate-600">
                <li className="flex items-center gap-3"><Shield className="w-5 h-5 text-[#0071BD]" /> Fast service confirmation</li>
                <li className="flex items-center gap-3"><CalendarDays className="w-5 h-5 text-[#0071BD]" /> Flexible schedule slots</li>
                <li className="flex items-center gap-3"><MapPin className="w-5 h-5 text-[#0071BD]" /> Real-time technician tracking</li>
              </ul>
            </div>
          </aside>
        </div>
